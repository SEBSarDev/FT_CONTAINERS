...
{	
  ...
  ins.insert ( std::pair<char,int>('a',100) );
  ins.insert ( std::pair<char,int>('z',200) );

  std::pair<map<char,int>::iterator,bool> reti;
  reti = ins.insert ( std::pair<char,int>('z',500) );
  ...
  ita = ins.insert (ito, std::pair<char,int>('b',300));  
    cout << ita->first << " => " << ita->second << '\n';
  ita = ins.insert (ito, std::pair<char,int>('c',400));
    cout << ita->first << " => " << ita->second << '\n';
  cout << "ins contains:\n";
...
//	a->second = "change"; // must not compile
	...
	if (a == cMap.end())
		...
		cout << a->first << "  " << a->second << endl;
	std::pair<map<std::string, std::string>::const_iterator, map<std::string, std::string>::const_iterator> constPair;
